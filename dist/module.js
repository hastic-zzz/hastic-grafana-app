...
/* harmony import */ var _model_analytic_unit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/analytic_unit */ "./model/analytic_unit.ts");
...
var AnalyticController = /** @class */ (function () {
    function AnalyticController(_panelObject, _analyticService, _emitter) {
        ...
        this._analyticUnitsSet = new _model_analytic_unit__WEBPACK_IMPORTED_MODULE_0__["AnalyticUnitsSet"](this._panelObject.anomalyTypes);
    ...
    AnalyticController.prototype.createNew = function () {
        this._newAnalyticUnitType = new _model_analytic_unit__WEBPACK_IMPORTED_MODULE_0__["AnalyticUnit"]();
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.refresh();
                        return [4 /*yield*/, this.analyticsController.saveNew(new _model_metric__WEBPACK_IMPORTED_MODULE_6__["MetricExpanded"](this.panel.datasource, this.panel.targets), this.datasourceRequest, this.panel.id)];
                    case 1:
                        _a.sent();
                        this.$scope.$digest();
                        this.render(this.seriesList);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, segments.map(function (s) { return new _model_analytic_unit__WEBPACK_IMPORTED_MODULE_0__["AnalyticSegment"](s.labeled, s.id, s.start, s.finish); })];
                }
            });
        });
    };
